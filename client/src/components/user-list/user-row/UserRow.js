        ...
        <tr>
            <td>
                <img src={user.imageUrl}
                    alt={`${getFullName(user)}'s profile`} className="image" />
            </td>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => userActionHandler(UserActionTypes.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => userActionHandler(UserActionTypes.Delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => userActionHandler(UserActionTypes.Details)}>
